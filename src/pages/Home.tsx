            ...
            {(hasSetting("social_facebook") || hasSetting("social_twitter") || hasSetting("social_instagram") || hasSetting("social_linkedin") || hasSetting("social_youtube") || hasSetting("social_tiktok")) && (
              <div className="hidden sm:flex items-center gap-2">
                {hasSetting("social_facebook") && (
                  <a href={getSetting("social_facebook")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <Facebook className="h-4 w-4" />
                  </a>
                )}
                {hasSetting("social_twitter") && (
                  <a href={getSetting("social_twitter")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <Twitter className="h-4 w-4" />
                  </a>
                )}
                {hasSetting("social_instagram") && (
                  <a href={getSetting("social_instagram")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <Instagram className="h-4 w-4" />
                  </a>
                )}
                {hasSetting("social_linkedin") && (
                  <a href={getSetting("social_linkedin")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <Linkedin className="h-4 w-4" />
                  </a>
                )}
                {hasSetting("social_youtube") && (
                  <a href={getSetting("social_youtube")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                    <Youtube className="h-4 w-4" />
                  </a>
                )}
                {hasSetting("social_tiktok") && (
                  <a href={getSetting("social_tiktok")} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
