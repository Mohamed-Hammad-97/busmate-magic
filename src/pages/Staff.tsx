      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">{t('staff.totalDrivers')}</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">{t('staff.activeDrivers')}</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">{t('staff.totalSupervisors')}</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">{t('staff.activeSupervisors')}</CardTitle>
              <UserCheck className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <TabsList>
              <TabsTrigger value="drivers">{t('staff.drivers')}</TabsTrigger>
              <TabsTrigger value="supervisors">{t('staff.supervisors')}</TabsTrigger>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-right">{t('staff.licenseNumber')}</TableHead>
                        ...
                        <TableRow key={driver.id}>
                          ...
                          <TableCell>
                            <Badge variant="outline" className="gap-1">
                              ...
                              {driver.city || t('common.notSpecified')}
                            </Badge>
                          </TableCell>
                          <TableCell>
                      ...
                      filteredSupervisors.map((supervisor: any) => (
                        <TableRow key={supervisor.id}>
                          ...
                          <TableCell>
                            <Badge variant="outline" className="gap-1">
                              <MapPin className="h-3 w-3" />
                              {supervisor.city || t('common.notSpecified')}
                            </Badge>
                          </TableCell>
                          <TableCell>
                            <Badge variant={supervisor.is_active ? 'default' : 'secondary'}>
                              {supervisor.is_active ? t('common.active') : t('common.inactive')}
                            </Badge>
                          </TableCell>
                          <TableCell>
                            <Button
            ...
            >
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="submit" disabled={saveDriverMutation.isPending}>
                  {saveDriverMutation.isPending ? t('common.loading') : t('common.save')}
                </Button>
              </div>
            </form>
          </DialogContent>
            ...
            >
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button type="submit" disabled={saveSupervisorMutation.isPending}>
                  {saveSupervisorMutation.isPending ? t('common.loading') : t('common.save')}
                </Button>
              </div>
            </form>
          </DialogContent>
