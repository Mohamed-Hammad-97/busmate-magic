...
Student name, Mother phone, Father phone, Emergency phone, Address.

- The on-screen table stays as it is (grade, subscription type, Fawry code, map link remain visible).
